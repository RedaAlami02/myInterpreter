...
Schedule (UTC): 0 16 * * 1-5   (deployed value — verify with `appwrite functions list`)
  → fires once at 16:00 UTC (17:00 Casablanca), Mon–Fri, after getprice's last run at 15:45.
